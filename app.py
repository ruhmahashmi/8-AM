    ...
    with app.app_context():
        ...
        if Course.query.count() == 0:
            mock_courses = [
                ...
                (10097, 'CIVC 101', 'Introduction to Civic Engagement', '09:00AM', '10:00AM', 'Monday', 3),
                (10098, 'CI 120', 'CCI Transfer Student Seminar', '11:00AM', '12:00PM', 'Wednesday', 3),
                (10099, 'CIVC 101', 'Introduction to Civic Engagement', '02:00PM', '03:00PM', 'Friday', 3),
                (10100, 'COOP 101', 'Career Management', '10:00AM', '11:00AM', 'Tuesday', 3),
            ]
